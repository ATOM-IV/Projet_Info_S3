    ...
    while (fgets(line, sizeof(line), file)) {
        ...
        if (i > (colonne_condition - 1) && strcmp(colonnes[colonne_condition - 1], valeur_condition) == 0) {
            ...
            if (i > 7 && strcmp(colonnes[7], "-") != 0) {
                ...
                insertionAVL(A,colonne[colonne_condition - 1],colonne[6],total)
            }
        }
    }
...
int main(){
    ...
    *v = 0;
    ...
    A = insertionAVL(A,2,70,60,h);
    A = insertionAVL(A,3,70,60,h);
    A = insertionAVL(A,4,70,60,h);
    A = insertionAVL(A,5,70,60,h);
    parcoursInfixe(A);
    return 0;
}